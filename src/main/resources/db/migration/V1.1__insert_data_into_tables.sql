insert into agent (name, last_name,first_name,email,phone_number,password,address)
...
insert into customer (name, first_name,last_name,email,address,salary,phone_number,agent_id)
...
insert into house (address,price,year,last_bought,last_sold,tax,customer_id)
